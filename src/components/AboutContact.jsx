  ...
  return (
    <div className="space-y-6 ">
      ...
      <div className="space-x-4">
        <button className="bg-blue-500 transition-all text-sm md:text-md duration-300 hover:bg-blue-600 text-white rounded-xl px-2 py-1 md:px-4 md:py-2">
            Email Us
        </button>
        <button className="bg-gray-500 transition-all text-sm md:text-md duration-300 hover:bg-gray-600 text-white rounded-xl  px-2 py-1 md:px-4 md:py-2">
            Follow Us
        </button>
      </div>
    </div>
